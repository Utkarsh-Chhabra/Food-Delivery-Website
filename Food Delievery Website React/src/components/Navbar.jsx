...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full z-50 transition-all duration-300 bg-slate-950/20 backdrop:blur-sm border-b border-amber-400">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-14 sm:h-16 md:h-20">
                    ...
                    <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
                        <a href="#feature" className="text-gray-300 hover:text-amber-400 lg:text-base">Home</a>
                    ...
                    <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
                        ...
                        <a href="#contact" className="text-grey-300 hover:text-amber-400"><User /></a>
                    </div>
